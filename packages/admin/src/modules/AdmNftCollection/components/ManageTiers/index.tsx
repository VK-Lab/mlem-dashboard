        ...
        <div className="flex flex-row gap-3 px-10 w-full md:flex-col md:px-3">
          <div className="gap-3 !w-[264px] !min-w-[264px] md:!w-full">
            ...
            <div className="flex flex-col items-center justify-start w-full mt-5">
              <div className="border-indigo-400 border-l-4 border-solid flex flex-col w-full round bg-indigo-900_cc pb-4 pt-[19px] px-4">
                <Text className="!text-white-A700 font-lexend w-full text-[13px]">
                  NFT Collection:
                </Text>
                <Text className="!text-white-A700 font-lexend w-full text-[13px] mt-1">
                  {nftCollectionId}
                </Text>
              </div>
            </div>
