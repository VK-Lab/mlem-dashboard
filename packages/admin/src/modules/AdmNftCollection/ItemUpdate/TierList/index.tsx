...
const AdmNftCollectionItemUpdateTierList = (props) => {
  ...
  return (
    <>
      ...
      <Modal show={openModal} onClose={() => setOpenModal(false)} position={modalPlacement} size="3xl">
        ...
        >
          <Modal.Header className="bg-gray-50 text-gray-950 uppercase">Manage Tiers</Modal.Header>
...
export default AdmNftCollectionItemUpdateTierList;
