...
type TabContentHeaderProps = React.DetailedHTMLProps<
  React.HTMLAttributes<HTMLDivElement>,
  HTMLDivElement
> &
  Partial<{}>;

const TabContentHeader: React.FC<TabContentHeaderProps> = (props) => {
    ...
    <>
      <div className="bg-gray-900 flex flex-row h-11 md:h-auto items-start justify-start rounded">
        <Button
          ...
          shape="round"
          color={router.pathname == AdminPaths.LIST_CAMPAIGNS ? "indigo_500_7f" : "gray_900"}
          size="sm"
          variant="fill"
        ...
        <Button
          ...
          shape="round"
          color={router.pathname == AdminPaths.LIST_NFT_COLLECTIONS ? "indigo_500_7f" : "gray_900"}
          size="sm"
          variant="fill"
        ...
        <Button
          ...
          shape="round"
          color={router.pathname == AdminPaths.LIST_BROKERS ? "indigo_500_7f" : "gray_900"}
          size="sm"
          variant="fill"
        ...
        <Button
          ...
          shape="round"
          color={router.pathname == AdminPaths.LIST_NFT_MINTS ? "indigo_500_7f" : "gray_900"}
          size="sm"
          variant="fill"
        ...
        <Button
          ...
          shape="round"
          color={router.pathname == AdminPaths.LIST_BENEFITS ? "indigo_500_7f" : "gray_900"}
          size="sm"
          variant="fill"
        ...
        <Button
          ...
          shape="round"
          color={router.pathname == AdminPaths.LIST_BENEFIT_CATEGORIES ? "indigo_500_7f" : "gray_900"}
          size="sm"
          variant="fill"
        ...
        <Button
          ...
          shape="round"
          color={router.pathname == AdminPaths.LIST_CLAIMS ? "indigo_500_7f" : "gray_900"}
          size="sm"
          variant="fill"
